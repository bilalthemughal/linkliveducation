...
{{--                    {!! Form::select('category_id', ['' => 'Choose Sub Category'] + $subCategories, null, ['class'=>'form-control']) !!}--}}
            ...
            <div class="form-row container" style="margin-top: 2rem;">
                ...
                <div class="col-sm-4">
                    {!! Form::textArea('tableOfContent', null, ['class'=>'form-control', 'placeholder'=>'Table of Content']) !!}
                </div>
                <div class="col-sm-4">
                    {!! Form::textArea('benefits', null, ['class'=>'form-control', 'placeholder'=>'Test Benefits']) !!}
                </div>
            </div>
            <div class="form-row container" style="margin-top: 2rem;">
                <div class="col-sm-6">
