        ...
        <script>
            ...
            $('#categories').on('change', function(e){
                ...
                $.get('/admin/getSubs/' + category_id, function(data){
                    console.log(data);
                    $('#subCategories').empty();
                    $('#subCategories').append('<option value="0" disabled selected>Choose Sub Categories</option>');
...
</html><?php /**PATH C:\xampp\htdocs\linkliveducation2\resources\views/admin/admin_app.blade.php ENDPATH**/ ?>