<?php $__env->startSection('content'); ?>
        ...
        <div class="container" style="margin-top: 10rem;">
            ...
            <div class="form-row container" style="margin-top: 2rem;">
                ...
                <div class="col-sm-4">
                    <?php echo Form::textArea('tableOfContent', null, ['class'=>'form-control', 'placeholder'=>'Table of Content']); ?>

                </div>
                <div class="col-sm-4">
                    <?php echo Form::textArea('benefits', null, ['class'=>'form-control', 'placeholder'=>'Test Benefits']); ?>
...
<?php echo $__env->make('admin.admin_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\linkliveducation2\resources\views/admin/pages/create_quiz.blade.php ENDPATH**/ ?>